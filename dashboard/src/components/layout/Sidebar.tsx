            ...
            <div className="flex flex-col h-full overflow-hidden">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800 shrink-0">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-2 py-1 text-xs rounded-md bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-colors border border-emerald-500/20 hover:border-emerald-500/30"
                        title="New Session"
                    >
                        <Plus size={13} />
                        New
